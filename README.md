...
# SISTEMA ELEIÇÃO - DATA A 
SISTEMA DE ELEIÇÃO com Java utilizando o gerenciador de dependências Apache Maven 
...
- Baixe o [repositório](git@github.com:diegoccx/appEleicao.git) da aplicação.
...
- Baixe e execute o Script SQL: [crud_java.sql](git@github.com:diegoccx/blob/master/crud_java.sql)
